...
class RegisterActivity : AppCompatActivity() {
    ...
    private val databaseReference: DatabaseReference =
        FirebaseDatabase.getInstance("https://historicvista-1414-default-rtdb.firebaseio.com")
...
//        btnTambahData = binding.btnRegister
...
// Model data untuk merepresentasikan entitas DataUser
